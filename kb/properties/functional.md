...
*Enforced-by:* proof:theories/Cek.v
Trusted: the theorem is over the Rocq model. Extraction, the Rocq kernel and the OCaml runtime sit outside it; ci/gen_tcb_report.sh generates the list of trust assumptions this project publishes.
...
*Enforced-by:* structural:theories/EffIR.v
...
*Enforced-by:* test:tests/diff_kv.ml
...
*Enforced-by:* proof:theories/Logic.v
*Enforced-by:* proof:theories/Dispatch.v
Trusted: the theorem is over the Rocq model. Extraction, the Rocq kernel and the OCaml runtime sit outside it; ci/gen_tcb_report.sh generates the list of trust assumptions this project publishes.
...
*Enforced-by:* proof:theories/KV.v
Trusted: the theorem is over the Rocq model. Extraction, the Rocq kernel and the OCaml runtime sit outside it; ci/gen_tcb_report.sh generates the list of trust assumptions this project publishes.
...
*Enforced-by:* proof:theories/Codec.v
Trusted: the theorem is over the Rocq model. Extraction, the Rocq kernel and the OCaml runtime sit outside it; ci/gen_tcb_report.sh generates the list of trust assumptions this project publishes.
