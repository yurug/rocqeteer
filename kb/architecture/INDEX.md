...
id: arch-index
type: index
summary: Routing for the architecture directory — the pipeline overview, the tower rationale, and the decision records.
domain: architecture
last-updated: 2026-07-19
depends-on: []
refines: []
related: [index, adr-index]
---
...
| `decisions/INDEX.md` | The 18 ADRs (0018 proposed), each traced to the failure mode or design review it defends against. |
