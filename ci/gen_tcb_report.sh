...
echo "| Expiry tower (ADR-0016 C1) | PROVEN discharge theorem (Elab.elab_simulates, axiom-free; < mutant rejected at the boundary) | theories/Elab.v; mode K = generated/progk_generated.ml over the kernel | diff_store_k (3000 adversarial states; d-1/d/d+1 per key) |"
