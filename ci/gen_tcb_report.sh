...
echo "| Runtime_Prims_refines | assumption (tcb-assumption) | apply_prim == Prims.prim_* | diff_prims (3000 pipeline states G1-G16 + direct per-prim pass, all 15 prims; R12 case folds exhaustive over all 256 single bytes + ci-dispatch pipeline C1-C5) |"
