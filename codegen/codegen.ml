(** rocq-eff-codegen (IR v2 R6: list elimination, adr-0012-list-elimination): lower an
...
let header =
  "(* Generated by rocq-eff-codegen (IR v2 R6). Source: theories/EffIR.v + Samples.v.\n\
  \   Direct-style; the EffIR monad has been erased. Do not edit manually.\n\
  \   See kb/spec/codegen.md and kb/architecture/decisions/adr-0012-list-elimination.md. *)\n\
   open Rkv\n"
