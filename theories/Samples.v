...
(** The GENERIC demonstration programs. The codegen's actual source-of-truth is
    [RocqeteerApps.AppSamples.all_programs_full] = this list ++ the application programs,
    kept out of this installed library to keep it domain-independent. *)
