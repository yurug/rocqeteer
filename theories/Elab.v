...
Local Ltac elab_pass H w wk :=
  ...
  repeat (match goal with
          ...
          | |- context [M.find ?k ?m] => destruct (M.find k m)
          | |- context [fd_find ?a ?b] => destruct (fd_find a b) as [[? [? ?]] |]
          | |- context [match ?x with Z0 => _ | Zpos _ => _ | Zneg _ => _ end] =>
              destruct x
